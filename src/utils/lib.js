...
(Taf.BinBuffer.prototype.allocate = function (t) {
  if (((t = this.position + t), !(this.buf != null && this.buf.length > t))) {
    const e = new ArrayBuffer(Math.max(256, 2 * t))
    this.buf != null && (new Uint8Array(e).set(new Uint8Array(this.buf)), (this.buf = void 0)),
    (this.buf = e),
    (this.vew = void 0),
...
(Taf.BinBuffer.prototype.getBuffer = function () {
  const t = new ArrayBuffer(this.len)
...
(Taf.BinBuffer.prototype.writeInt64 = function (t) {
  this.allocate(8),
  this.vew.setUint32(this.position, Number.parseInt(t / 4294967296)),
...
(Taf.BinBuffer.prototype.readInt64 = function () {
  const t = this.vew.getUint32(this.position)
  const e = this.vew.getUint32(this.position + 4)
  return (this.position += 8), 4294967296 * t + e
}),
(Taf.BinBuffer.prototype.readFloat = function () {
  const t = this.vew.getFloat32(this.position)
  return (this.position += 4), t
}),
(Taf.BinBuffer.prototype.readDouble = function () {
  const t = this.vew.getFloat64(this.position)
...
(Taf.JceOutputStream.prototype.writeBoolean = function (t, e) {
  this.writeInt8(t, e == 1 ? 1 : 0)
}),
(Taf.JceOutputStream.prototype.writeInt8 = function (t, e) {
  e == 0 ? this.writeTo(t, Taf.DataHelp.EN_ZERO) : (this.writeTo(t, Taf.DataHelp.EN_INT8), this.buf.writeInt8(e))
}),
(Taf.JceOutputStream.prototype.writeInt16 = function (t, e) {
  e >= -128 && e <= 127 ? this.writeInt8(t, e) : (this.writeTo(t, Taf.DataHelp.EN_INT16), this.buf.writeInt16(e))
}),
(Taf.JceOutputStream.prototype.writeInt32 = function (t, e) {
  e >= -32768 && e <= 32767 ? this.writeInt16(t, e) : (this.writeTo(t, Taf.DataHelp.EN_INT32), this.buf.writeInt32(e))
}),
...
(Taf.JceOutputStream.prototype.writeFloat = function (t, e) {
  e == 0 ? this.writeTo(t, Taf.DataHelp.EN_ZERO) : (this.writeTo(t, Taf.DataHelp.EN_FLOAT), this.buf.writeFloat(e))
}),
(Taf.JceOutputStream.prototype.writeDouble = function (t, e) {
  e == 0 ? this.writeTo(t, Taf.DataHelp.EN_ZERO) : (this.writeTo(t, Taf.DataHelp.EN_DOUBLE), this.buf.writeDouble(e))
}),
(Taf.JceOutputStream.prototype.writeStruct = function (t, e) {
  if (void 0 == e.writeTo)
    throw new Error('not defined writeTo Function')
...
(Taf.JceOutputStream.prototype.writeBytes = function (t, e) {
  if (!(e instanceof Taf.BinBuffer))
    throw new Error('value not instanceof Taf.BinBuffer')
...
(Taf.JceOutputStream.prototype.writeVector = function (t, e) {
  ...
  for (let i = 0; i < e.value.length; i++) e.proto._write(this, 0, e.value[i])
}),
(Taf.JceOutputStream.prototype.writeMap = function (t, e) {
  this.writeTo(t, Taf.DataHelp.EN_MAP), this.writeInt32(0, e.size())
  for (const i in e.value) e.kproto._write(this, 0, i), e.vproto._write(this, 1, e.value[i])
}),
...
(Taf.JceInputStream.prototype.peekFrom = function () {
  const t = this.buf.position
  const e = this.readFrom()
  return (
    (this.buf.position = t),
    {
      tag: e.tag,
  ...
  switch (t) {
    ...
    case Taf.DataHelp.EN_SIMPLELIST:
      ...
      if (s.type != Taf.DataHelp.EN_INT8)
        throw new Error(`skipField with invalid type, type value: ${t},${s.type}`)
...
(Taf.JceInputStream.prototype.skipToStructEnd = function () {
  for (;;) {
    const t = this.readFrom()
    if ((this.skipField(t.type), t.type == Taf.DataHelp.EN_STRUCTEND))
      return
  }
}),
(Taf.JceInputStream.prototype.skipToTag = function (t, e) {
  for (; this.buf.position < this.buf.length;) {
    const i = this.peekFrom()
  ...
  if (e)
    throw new Error(`require field not exist, tag:${t}`)
  return !1
}),
(Taf.JceInputStream.prototype.readBoolean = function (t, e, i) {
  return this.readInt8(t, e, i) == 1 ? !0 : !1
}),
(Taf.JceInputStream.prototype.readInt8 = function (t, e, i) {
  if (this.skipToTag(t, e) == 0)
    return i
  const r = this.readFrom()
  switch (r.type) {
    case Taf.DataHelp.EN_ZERO:
      return 0
    case Taf.DataHelp.EN_INT8:
  ...
  throw new Error(`read int8 type mismatch, tag:${t}, get type:${r.type}`)
}),
...
(Taf.JceInputStream.prototype.readInt64 = function (t, e, i) {
  ...
  throw new Error(`read int64 type mismatch, tag:${t}, get type:${h.type}`)
}),
(Taf.JceInputStream.prototype.readFloat = function (t, e, i) {
  ...
  throw new Error(`read float type mismatch, tag:${t}, get type:${h.type}`)
}),
(Taf.JceInputStream.prototype.readDouble = function (t, e, i) {
  ...
  throw new Error(`read double type mismatch, tag:${t}, get type:${h.type}`)
}),
...
(Taf.JceInputStream.prototype.readString = function (t, e, i) {
  ...
  throw new Error(`read 'string' type mismatch, tag: ${t}, get type: ${r.type}.`)
}),
...
(Taf.JceInputStream.prototype.readBytes = function (t, e, i) {
  ...
  if (r.type == Taf.DataHelp.EN_SIMPLELIST) {
    const n = this.readFrom()
    if (n.type != Taf.DataHelp.EN_INT8)
      throw new Error(`type mismatch, tag:${t},type:${r.type},${n.type}`)
    var s = this.readInt32(0, !0)
    if (s < 0)
      throw new Error(`invalid size, tag:${t},type:${r.type},${n.type}`)
  ...
  throw new Error(`type mismatch, tag:${t},type:${r.type}`)
}),
(Taf.JceInputStream.prototype.readVector = function (t, e, i) {
  ...
  const r = this.readFrom()
  if (r.type != Taf.DataHelp.EN_LIST)
    throw new Error(`read 'vector' type mismatch, tag: ${t}, get type: ${r.type}`)
  const n = this.readInt32(0, !0)
  if (n < 0)
    throw new Error(`invalid size, tag: ${t}, type: ${r.type}, size: ${n}`)
  for (let s = 0; n > s; ++s) i.value.push(i.proto._read(this, 0, i.proto._clone()))
  return i
}),
(Taf.JceInputStream.prototype.readMap = function (t, e, i) {
  ...
  if (r.type != Taf.DataHelp.EN_MAP)
    throw new Error(`read 'map' type mismatch, tag: ${t}, get type: ${r.type}`)
  const n = this.readInt32(0, !0)
  if (n < 0)
    throw new Error(`invalid map, tag: ${t}, size: ${n}`)
  for (let s = 0; n > s; s++) {
    const o = i.kproto._read(this, 0, i.kproto._clone())
    const a = i.vproto._read(this, 1, i.vproto._clone())
    i.put(o, a)
  }
  return i
})
...
(Taf.Wup.prototype.writeTo = function () {
  const t = new Taf.JceOutputStream()
  return (
...
(Taf.Wup.prototype.encode = function () {
  const t = new Taf.JceOutputStream()
  this.iVersion == 3 ? t.writeMap(0, this.newdata) : t.writeMap(0, this.data), (this.sBuffer = t.getBinBuffer())
  let e = new Taf.BinBuffer()
  e = this.writeTo()
  const i = new Taf.BinBuffer()
  return i.writeInt32(4 + e.len), i.writeBytes(e), i
}),
(Taf.Wup.prototype.writeBoolean = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeBoolean(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBuffer())) }
  else {
    let r = this.data.get(t)
    const n = TAF.TypeHelp.BOOLEAN
    if (void 0 == r) {
      const s = new Taf.Map(Taf.STRING, Taf.STRING)
      r = s
    }
...
(Taf.Wup.prototype.writeInt8 = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeInt8(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBuffer())) }
  else {
    let r = this.data.get(t)
    const n = TAF.TypeHelp.CHAR
    if (void 0 == r) {
      const s = new Taf.Map(Taf.STRING, Taf.STRING)
      r = s
    }
...
(Taf.Wup.prototype.writeInt16 = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeInt16(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBuffer())) }
  else {
    let r = this.data.get(t)
    const n = TAF.TypeHelp.SHORT
    if (void 0 == r) {
      const s = new Taf.Map(Taf.STRING, Taf.STRING)
      r = s
    }
...
(Taf.Wup.prototype.writeInt32 = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeInt32(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBuffer())) }
  else {
    let r = this.data.get(t)
    const n = TAF.TypeHelp.INT32
    if (void 0 == r) {
      const s = new Taf.Map(Taf.STRING, Taf.STRING)
      r = s
    }
...
(Taf.Wup.prototype.writeInt64 = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeInt64(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBuffer())) }
  else {
    let r = this.data.get(t)
    const n = TAF.TypeHelp.INT64
    if (void 0 == r) {
      const s = new Taf.Map(Taf.STRING, Taf.STRING)
      r = s
    }
...
(Taf.Wup.prototype.writeFloat = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeFloat(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBuffer())) }
  else {
    let r = this.data.get(t)
    const n = TAF.TypeHelp.FLOAT
    if (void 0 == r) {
      const s = new Taf.Map(Taf.STRING, Taf.STRING)
      r = s
    }
...
(Taf.Wup.prototype.writeDouble = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeDouble(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBuffer())) }
  else {
    let r = this.data.get(t)
    const n = TAF.TypeHelp.DOUBLE
    if (void 0 == r) {
      const s = new Taf.Map(Taf.STRING, Taf.STRING)
      r = s
    }
...
(Taf.Wup.prototype.writeString = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeString(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBuffer())) }
  else {
    let r = this.data.get(t)
    const n = Taf.TypeHelp.STRING
    if (void 0 == r) {
      const s = new Taf.Map(Taf.STRING, Taf.STRING)
      r = s
    }
...
(Taf.Wup.prototype.writeVector = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeVector(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBinBuffer())) }
  else {
    let r = this.data.get(t)
    const n = e._className()
    if (void 0 == r) {
      const s = new Taf.Map(Taf.STRING, Taf.STRING)
      r = s
    }
...
(Taf.Wup.prototype.writeStruct = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeStruct(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBuffer())) }
  else {
    let r = this.data.get(t)
    const n = ' '
    if (void 0 == r) {
...
(Taf.Wup.prototype.writeBytes = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeBytes(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBuffer())) }
  else {
    let r = this.data.get(t)
    const n = 'vec'
    if (void 0 == r) {
...
(Taf.Wup.prototype.writeMap = function (t, e) {
  const i = new Taf.JceOutputStream()
  if ((i.writeMap(0, e), this.iVersion == 3)) { this.newdata.put(t, new Taf.BinBuffer(i.getBuffer())) }
  else {
    let r = this.data.get(t)
    const n = Taf.Util.getClassType(e)
    if (void 0 == r) {
      const s = new Taf.Map(Taf.STRING, Taf.STRING)
      r = s
    }
...
(Taf.Wup.prototype.decode = function (t) {
  let e = new Taf.JceInputStream(t)
  const i = e.buf.vew.getInt32(e.buf.position)
  if (i < 4)
    throw new Error('packet length too short')
  ;(e.buf.position += 4),
  this.readFrom(e),
...
(Taf.Wup.prototype.readBoolean = function (t) {
  let e, i
  if (this.iVersion == 3) {
    if (((e = this.newdata.get(t)), void 0 == e))
      throw new Error(`UniAttribute not found key:${t}`)
    ...
    const s = e.get(n)
    if (void 0 == s)
      throw new Error(`UniAttribute not found type:${n}`)
...
(Taf.Wup.prototype.readDouble = function (t) {
  ...
  if (this.iVersion == 3) {
    ...
    if (((e = this.newdata.get(t)), void 0 == e))
      throw new Error(`UniAttribute not found key:${t}`)
    const r = Taf.TypeHelp.DOUBLE
    const n = e.get(r)
    if (void 0 == n)
      throw new Error(`UniAttribute not found type:${r}`)
...
(Taf.Wup.prototype.readVector = function (t, e, i) {
  let r
  if (this.iVersion == 3) {
    if (((r = this.newdata.get(t)), void 0 == r))
      throw new Error(`UniAttribute not found key:${t}`)
    ...
    const s = r.get(i)
    if (void 0 == s)
      throw new Error(`UniAttribute not found type:${i}`)
...
(Taf.Util.jcestream = function (t) {
  ...
  for (let e = new Uint8Array(t), i = '', r = 0; r < e.length; r++)
    r != 0 && r % 16 == 0 ? (i += '\n') : r != 0 && (i += ' '), (i += (e[r] > 15 ? '' : '0') + e[r].toString(16))
...
(Taf.Util.ajax = function (t, e, i, r) {
  ...
  const s = function () {
    n.readyState === 4
        && (n.status === 200 || n.status === 304 ? i(Taf.Util.str2ab(n.response)) : r(n.status),
